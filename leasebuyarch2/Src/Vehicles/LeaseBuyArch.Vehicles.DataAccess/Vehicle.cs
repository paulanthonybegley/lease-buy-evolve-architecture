...
public sealed class Vehicle
{
        ...
        decimal residualPercentageAt36Months, string status)
    {
        ...
        Msrp = msrp; ResidualPercentageAt36Months = residualPercentageAt36Months; Status = status;
    }
    ...
    public void MarkAsLeased() => Status = "Leased";
    public void MarkAsOwned() => Status = "Owned";
}
