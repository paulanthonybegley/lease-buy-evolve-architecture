...
using EvolutionaryArchitecture.LeaseBuyArch.Leasing.PrepareLease.BusinessRules;
using EvolutionaryArchitecture.LeaseBuyArch.Leasing.SignLease.BusinessRules;

namespace EvolutionaryArchitecture.LeaseBuyArch.Leasing.Data;
...
internal sealed class Lease
{
        ...
        int annualMileageLimit, decimal monthlyPayment, DateTimeOffset preparedAt)
    {
        ...
        AnnualMileageLimit = annualMileageLimit;
        MonthlyPayment = monthlyPayment;
        PreparedAt = preparedAt;
    }

    internal static Lease Prepare(Guid customerId, Guid vehicleId, decimal vehicleMsrp,
        decimal residualPercentage, decimal moneyFactor, int termMonths,
